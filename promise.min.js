...
"object"===typeof a};m=function(){function a(a,b){this.resolve=a;this.reject=b;this.resolver=new k;this.promise=this.resolver.promise}a.prototype.trigger=function(a,b){var c,d;d=this.resolver;c=this[a];if(h(c))q(function(){try{d.resolve(c(b))}catch(a){d.reject(a)}});else d[a](b)};return a}();k=function(){function a(){this.promise=new n(this);this.consequences=[];this.completed=!1;this.completionValue=this.completionAction=null}a.prototype.then=function(a,b){var c;c=new m(a,b);this.completed?c.trigger(this.completionAction,
this.completionValue):this.consequences.push(c);return c.promise};a.prototype.resolve=function(a){var b,c,d,t;if(!this.completed)try{if(a===this.promise)throw new TypeError("A Promise cannot be resolved with itself.");if((r(a)||h(a))&&h(t=a.then)){c=!1;try{d=this,t.call(a,function(a){c||(c=!0,d.resolve(a))},function(a){c||(c=!0,d.reject(a))})}catch(g){b=g,c||this.reject(b)}}else this.complete("resolve",a)}catch(f){b=f,this.reject(b)}};a.prototype.reject=function(a){this.completed||this.complete("reject",
a)};a.prototype.complete=function(a,b){var c,d,f,g;this.completionAction=a;this.completionValue=b;this.completed=!0;g=this.consequences;d=0;for(f=g.length;d<f;d++)c=g[d],c.trigger(this.completionAction,this.completionValue);this.consequences=null};return a}();n=function(){return function(a){this.then=function(e,b){return a.then(e,b)}}}();f=function(){return function(){var a;a=new k;this.promise=a.promise;this.resolve=function(e){return a.resolve(e)};this.reject=function(e){return a.reject(e)}}}();
l="undefined"!==typeof exports&&null!==exports?exports:window;l.Deferred=f;l.defer=function(){return new f}}).call(this);
